      ...
      <Transition appear show={cardIsOpen} as={Fragment}>
        ...
        >
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Panel className="fixed relative left-0 z-50  h-full min-w-[363px] overflow-y-auto overflow-x-hidden bg-white  newcard:inset-x-4 newcard:top-24 newcard:h-auto newcard:w-[500px] newcard:rounded-xl sm:left-24 md:left-1/3 ">
              <XMarkIcon
